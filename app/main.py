...
from app.api.routes import targets, evidence, scoring, contradictions, gaps, narrative, narration, agent, momentum, graph, cross_checks
...
app.include_router(cross_checks.router)
